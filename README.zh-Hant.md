...
[English](README.md) · [Español](README.es.md) · [Français](README.fr.md) · [Deutsch](README.de.md) · [Português (Brasil)](README.pt-BR.md) · [日本語](README.ja.md) · [简体中文](README.zh-Hans.md) · **繁體中文** · [한국어](README.ko.md) · [العربية](README.ar.md)
...
Next.js 15（App Router，靜態匯出）· TypeScript · Tailwind CSS · shadcn 風格 UI · Zustand · next-intl · pdf-lib / PDF.js · Canvas · FFmpeg WASM · PWA Service Worker
