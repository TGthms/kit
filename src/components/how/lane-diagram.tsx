 ...
 * the device holding your files, Kit's static host, the app coming down once
 * (solid arrow), and the only request a tool can send — currency pair codes
 * (dashed arrow). Iconographic on purpose; the accessible explanation is the
 * two lists rendered next to it. Mirrored in RTL.
 */
  ...
  return (
    <div aria-hidden className="flex justify-center py-1 text-muted-foreground">
      ...
      >
        ...
        {/* app files: host to device, once; the doc rides in a gap in the line */}
        ...
        {/* rates: device to host, pair codes only; coin sits in a gap */}
