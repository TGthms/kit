...
// currentColor + no fixed dimensions so it inherits size (h-*/w-* utility classes)
// and color (text-muted-foreground on the parent <p>) in both light and dark mode.
      ...
      {supportOpen ? (
        ...
        >
          ...
          >
            ...
            */}
            <p className="flex shrink-0 items-center justify-center gap-1.5 border-t bg-muted/30 px-5 py-2.5 text-center text-xs text-muted-foreground sm:px-6">
