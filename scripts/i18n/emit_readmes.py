...
COPY: dict[str, dict[str, str]] = {
    "en": {
        ...
        "req": "Requirements: **Node.js 22.13+** (see `.nvmrc`).",
        ...
        "stack_h": "Tech stack",
        "stack": "Next.js 15 (App Router, static export) · TypeScript · Tailwind CSS · shadcn-style UI · Zustand · next-intl · pdf-lib / PDF.js · Canvas · FFmpeg WASM · PWA service worker",
        "license_h": "License",
    ...
    "es": {
        ...
        "req": "Necesitas **Node.js 22.13+** (ver `.nvmrc`).",
        ...
        "stack_h": "Tecnología",
        "stack": "Next.js 15 (App Router, exportación estática) · TypeScript · Tailwind CSS · UI estilo shadcn · Zustand · next-intl · pdf-lib / PDF.js · Canvas · FFmpeg WASM · service worker PWA",
        "license_h": "Licencia",
        "license": "[MIT](LICENSE) © Tim G (GitHub: [TGthms](https://github.com/TGthms))",
        "h_pdf": "PDF",
        "h_images": "Imágenes",
